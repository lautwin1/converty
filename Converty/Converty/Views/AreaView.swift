...
struct AreaMenu: View {
    @State private var topNumInput: String = ""
    @State private var bottomNumInput: String = ""
    @State private var topSelectedUnit: String = "Square foot"
    @State private var bottomSelectedUnit: String = "Square meter"
    ...
    var body: some View {
        VStack {
            ...
            VStack {
                ...
                .textFieldStyle(AreaTextFieldStyle())
                ...
                .overlay (
                    RoundedRectangle(cornerRadius: 10)
                        .stroke(Color("Pastel Red"), lineWidth: 2)
                        .frame(width: 250)
                )
                .offset(y: 15)
            }
